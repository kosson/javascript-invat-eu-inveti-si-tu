...
Pe scurt, legătura care se realizează la momentul compilării între funcție și mediul lexical în care a fost declarată, se numește **closure**. E ca dorul de casă. Chiar dacă ești plecat, vei avea mereu o conexiune cu toate lucrurile de acasă pentru că le **ții minte**, știi unde sunt și *ce valoare au pentru tine*. Dar în același timp ești conectat cu toate lucrurile de unde ai ajuns, ceea ce ar fi legătura `this` în cazul execuției funcției.
